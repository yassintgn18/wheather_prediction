...
def reset_db():
    try:
        ...
        precipitation = 0
        wind_speed = 0
        for action in ["bonne", "mauvaise"]:
            new_statue = SECONDE_USERS_STATES_DATA_BASE(id_user=id_user,statue2=action, temperature2=temperature,
                                                        cloud_cover2=cloud_cover, precipitation2=precipitation,
...
def statue(action='2'):
    try:
        ...
        new_statue = SECONDE_USERS_STATES_DATA_BASE(id_user=id_user,
                                                    statue2=action,
