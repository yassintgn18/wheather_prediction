...
def start():
    ...
    if current_user.is_authenticated:
      ...
      with app.app_context():
          ...
          records = SECONDE_USERS_STATES_DATA_BASE.query.filter(SECONDE_USERS_STATES_DATA_BASE.id_user == id).all()
        ...
        if user is None:
            ...
            for action in list_status:
              ...
              try:
                ...
                flash(f"the statue {action} add successfully to the database withe the id: {user_id}!!!")
                
              
              except Exception as e:
              
                  flash(f"the was an exception in {e}")
